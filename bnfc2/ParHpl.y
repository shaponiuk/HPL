...
StructOrInterfaceOrType : Struct { StructOrInterfaceOrTypeS $1 } 
  | Interface { StructOrInterfaceOrTypeI $1 }
...
Struct : 'struct' Ident '{' StructBody '}' ';' { StructB $2 $4 } 
  | 'struct' Ident ':' ListInterfaceId '{' StructBody '}' ';' { StructI $2 $4 $6 }
...
InterfaceId : Ident { InterfaceIdB $1 } 
...
Interface :: { Interface }
Interface : 'interface' InterfaceId '{' InterfaceBody '}' ';' { InterfaceB $2 $4 } 
  | 'interface' InterfaceId ':' ListInterfaceId '{' InterfaceBody '}' ';' { InterfaceBInh $2 $4 $6 }


InterfaceBody :: { InterfaceBody }
InterfaceBody : ListFunOrRefDecl { InterfaceBodyB (reverse $1) } 


FunOrRefDecl :: { FunOrRefDecl }
FunOrRefDecl : 'fun' Type Ident ';' { FunOrRefDeclF $2 $3 } 
  | 'sus' 'fun' Type Ident ';' { FunOrRefDeclSF $3 $4 }
  | 'ref' Type Ident ';' { FunOrRefDeclR $2 $3 }

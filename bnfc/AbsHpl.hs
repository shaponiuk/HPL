...
data StructOrInterfaceOrType =
 ...
 | StructOrInterfaceOrTypeI Interface
 | StructOrInterfaceOrTypeT AlgType
  deriving (Eq,Ord,Show)

data Struct =
   StructB Ident StructBody
 | StructI Ident [InterfaceId] StructBody
  deriving (Eq,Ord,Show)
...
data Interface =
   InterfaceB InterfaceId InterfaceBody
 | InterfaceBInh InterfaceId [InterfaceId] InterfaceBody
  deriving (Eq,Ord,Show)

data InterfaceBody =
   InterfaceBodyB [FunOrRefDecl]
  deriving (Eq,Ord,Show)

data FunOrRefDecl =
   FunOrRefDeclF Type Ident
 | FunOrRefDeclSF Type Ident
 | FunOrRefDeclR Type Ident
  deriving (Eq,Ord,Show)
